...
**Note.** _We will use the Einstein summation convention from now on. For example, $\Gamma^k_{ij} \Gamma^l_{km} = \sum_k \Gamma^k_{ij} \Gamma^l_{km}$._
...
<BlogImage imagePath='/img/manifold-gaussians/gaussians_geo.png' altText='Geodesic paths of Gaussians.' />
