...
<BlogImage imagePath='/src/assets/img/plotting/mpl_vs_tikz.png' />
...
6. At this point, you will already have a quite aesthetically pleasing figure, cf. below. Notice that the font face and size are consistent with the paper's text. However, notice that we need to improve the plot further, e.g. by unhiding the x- and y-tick labels.
    <BlogImage imagePath='/src/assets/img/plotting/tikzplotlib_raw.png' />
...
<BlogImage imagePath='/src/assets/img/plotting/tikzplotlib_almostfinal.png' />
...
<BlogImage imagePath='/src/assets/img/plotting/tikzplotlib_final.png' />
