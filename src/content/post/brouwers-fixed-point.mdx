...
<BlogImage imagePath='/img/brouwers-fixed-point/map_r.svg' altText="Casting a ray to the ball's shell." />
...
<BlogImage imagePath='/img/brouwers-fixed-point/comm_diag.svg' altText="Commutative diagram." />
...
<BlogImage imagePath='/img/brouwers-fixed-point/comm_diag_hom.svg' altText="Reduced homology." />
