...
<div role='alert' class='alert alert-error alert-soft'>
  ...
  <span>
    **DO NOT** use LLMs when writing. It should only be used to proofread, i.e.,
    **after** you're done. Using an LLM when to improve your writing skill is akin to
    going to the gym and letting your personal trainer lift the weights for you.
  </span>
</div>
