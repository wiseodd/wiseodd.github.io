...
<BlogImage imagePath="/img/natural-gradient/param_space_dist.png" altText="A parametrization of Gaussians." fullWidth />

<BlogImage imagePath="/img/natural-gradient/param_space_dist2.png" altText="Another parametrization of Gaussians." fullWidth />
