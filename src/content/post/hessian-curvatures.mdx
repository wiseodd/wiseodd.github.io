...
<BlogImage imagePath='/img/hessian-curvatures/pushforward.png' altText='Pushforward.' fullWidth />
...
<BlogImage imagePath='/img/hessian-curvatures/graph_hypersurface.png' altText='The graph of a function as a hypersurface.' fullWidth />
...
<BlogImage imagePath='/img/hessian-curvatures/II.png' altText='The second fundamental form.' />
...
<BlogImage imagePath='/img/hessian-curvatures/unit_normal.png' altText='A unit normal vector field.' />
...
<BlogImage imagePath='/img/hessian-curvatures/curvature_plane_curv.png' altText='Principal curvatures.' />
...
<BlogImage imagePath='/img/hessian-curvatures/principal_curvatures_extrinsic.png' altText='Principal curvatures are extrinsic.' fullWidth />
...
**Proposition 2.** _Suppose $L \subseteq \R^{d+1}$ is a loss landscape with its graph parametrization and let $\theta_* \in \R^d$ be a critical point of $\ell$ and $p_* := (\theta_*^1, \dots, \theta_*^d, \ell(\theta_*)) \in L$. Then the matrix of the shape operator $s$ of $L$ at $p_*$ is equal to the Hessian matrix of $\ell$ at $\theta_*$._
...
<BlogImage imagePath='/img/hessian-curvatures/reparametrization_curvatures.png' altText='Principal curvatures are not invariant under reparametrization.' fullWidth />
