...
Otherwise, the student continue with MSc Thesis for the next 2 terms (in total, five terms—1.5 years).
...
2. Outstanding soft-skills:
    ...
    - This and the previous points are **just as important** as the technical requirements below.
