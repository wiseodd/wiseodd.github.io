...
Let $$(\M, g)$$ be a Riemannian submanifold of a Riemannian manifold $$(\tilde{\M}, \tilde{g})$$. Then, $$g$$ is the induced metric $$g = \iota^*_\M \tilde{g}$$, where $$\iota_\M: \M \hookrightarrow \tilde{\M}$$ is the inclusion map. Note that, the expression $$\iota^*_\M \tilde{g}$$ is called the **_pullback metric_** or the **_induced metric_** of $$\tilde{g}$$ by $$\iota_\M$$ and is defined by
